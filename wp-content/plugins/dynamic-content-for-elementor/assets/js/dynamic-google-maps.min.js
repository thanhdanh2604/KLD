(function($){var DyncontEl_GoogleMapsHandler=function($scope,$){const initMap=()=>{var $map=$scope.find('.map');var map=$map[0];var bounds;let positions=$map[0].dataset.positions;try{positions=JSON.parse(positions)}catch(err){console.error(err);positions=[]}
