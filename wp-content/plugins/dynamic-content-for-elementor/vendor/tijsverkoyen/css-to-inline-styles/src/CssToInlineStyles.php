...
namespace DynamicOOOS\TijsVerkoyen\CssToInlineStyles;

use DynamicOOOS\Symfony\Component\CssSelector\CssSelector;
use DynamicOOOS\Symfony\Component\CssSelector\CssSelectorConverter;
use DynamicOOOS\Symfony\Component\CssSelector\Exception\ExceptionInterface;
use DynamicOOOS\TijsVerkoyen\CssToInlineStyles\Css\Processor;
use DynamicOOOS\TijsVerkoyen\CssToInlineStyles\Css\Property\Processor as PropertyProcessor;
use DynamicOOOS\TijsVerkoyen\CssToInlineStyles\Css\Rule\Processor as RuleProcessor;
class CssToInlineStyles
{
    private $cssConverter;
    public function __construct()
    {
        if (\class_exists('DynamicOOOS\\Symfony\\Component\\CssSelector\\CssSelectorConverter')) {
